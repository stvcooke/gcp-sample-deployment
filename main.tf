...
locals {
  project_alias = "couscous"
}

data "google_client_config" "this" {}

# this probably isn't even necessary for this project.
# module "vpc" {
#   source  = "terraform-google-modules/network/google"
#   version = "~> 9.3"

#   project_id   = data.google_client_config.this.project
#   network_name = "${local.project_alias}-vpc"
#   routing_mode = "GLOBAL"
...
#       purpose       = "REGIONAL_MANAGED_PROXY" # set to global for production workloads
#       role          = "ACTIVE"
